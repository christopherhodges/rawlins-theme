...
function rawlins_tiny_mce_edits( $args ) {
...
add_filter( 'tiny_mce_before_init', 'rawlins_tiny_mce_edits' );
...
function rawlins_toolbars( $toolbars ){
...
add_filter( 'acf/fields/wysiwyg/toolbars' , 'rawlins_toolbars'  );

// For the FIRST row of the Full WYSIWYG buttons
function rawlins_tinymce_buttons($buttons) {
...
add_filter('mce_buttons','rawlins_tinymce_buttons');

// For the SECOND row of the Full WYSIWYG buttons
function rawlins_tinymce_buttons2($buttons) {
	//echo "<pre>"; print_r($buttons); echo "</pre>";
	/*
	Array (
	    [0] => formatselect
...
add_filter('mce_buttons_2','rawlins_tinymce_buttons2');
