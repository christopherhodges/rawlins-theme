...
define( 'IMAGES', STYLEDIR. "/images");
    define( 'IMAGES_SERVER', rawlins_get_stylesheet_path(). "/images");
define( 'JSDIR', STYLEDIR."/js");
define( 'CSSDIR', STYLEDIR."/css");
define( 'FONTS', STYLEDIR."/fonts");
define( 'MODDIR', STYLEDIR."/modules");
    define( 'MODDIR_SERVER', rawlins_get_stylesheet_path(). "/modules");
...
### rawlins_get_home_path() is the exact same function, except in name.
...
function rawlins_get_home_path() {
...
function rawlins_get_stylesheet_path() {
    $return = false;
    $home_path = rawlins_get_home_path();
